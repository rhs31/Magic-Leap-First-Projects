    ...
    public class ControllerFeedbackExample : MonoBehaviour
    {
        ...
        private void HandleOnButtonDown(byte controllerId, MLInputControllerButton button)
        {
                ...
                button == MLInputControllerButton.Bumper)
            {
                ...
                GameObject GO = Instantiate(BulletGO, Camera.main.transform.position + Camera.main.transform.forward, transform.rotation);

                GO.GetComponent<Rigidbody>().AddForce(Camera.main.transform.forward * 65);
            }
        }
